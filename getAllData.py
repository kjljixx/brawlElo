...
def getAllData(dataFileNames, teamsFileName, teamsToAvoidFileName):
  results = {}
  for dataFileName in dataFileNames:
    getData(dataFileName, teamsFileName, teamsToAvoidFileName, results)
  return results
...
if __name__ == "__main__":
  ...
  results = getAllData(matchFiles, "bsc-2024-raw-main/leaderboards/2024-" + regionAbbrev.lower() + "-leaderboard.json", "avoidedTeams.json")
  
  outputFileName = regionAbbrev.lower() + ".pgn"
  ...
  file.close()
  os.system("ordo -G -o " + regionAbbrev.lower() + "-rankings.txt -t 50 -p " + regionAbbrev.lower() + ".pgn")